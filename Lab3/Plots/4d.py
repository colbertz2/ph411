...
time_wave, input_wave, output_wave = np.genfromtxt('../Data/4d_waveform.csv', delimiter=',', usecols=(0,1,3), skiprows=1, unpack=True)

time_fftInput, amplitude_fftInput = np.genfromtxt('../Data/4d_fft1.csv', delimiter=',', usecols=(0,1), skiprows=1, unpack=True)

time_fftOutput, amplitude_fftOutput= np.genfromtxt('../Data/4d_fft2.csv', delimiter=',', usecols=(0,1), skiprows=1, unpack=True)
...
# Plot some stuff
plt.title("CR Circuit with AM Sine Wave Input")
plt.figure(1)
plt.subplot(311)
